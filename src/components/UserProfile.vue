...
<!--          &lt;!&ndash;            <img :src="user2.topBadges[0].image300px" alt="alt"/>&ndash;&gt;-->

<!--          &lt;!&ndash;            <p>{{ user2.topBadges[0].name }}</p>&ndash;&gt;-->
<!--          &lt;!&ndash;            <strong>Name: </strong>{{ user2.topBadges[0].dateTime }}<br>&ndash;&gt;-->

<!--          &lt;!&ndash;            <strong>Date: </strong>{{ user2.topBadges[0].dateTime }}<br>&ndash;&gt;-->
<!--          &lt;!&ndash;            <strong>Times Achieved: </strong>{{ user2.topBadges[0].timeAchieved }}<br>&ndash;&gt;-->
<!--          &lt;!&ndash;          </div>&ndash;&gt;-->
<!--          &lt;!&ndash;          <div class="col-md-3">&ndash;&gt;-->
