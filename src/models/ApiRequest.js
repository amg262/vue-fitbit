...
const json = {
    ...
    // 'sleepList': 'https://api.fitbit.com/1.2/user/' + process.env.VUE_APP_FITBIT_USER_ID + '/sleep/list.json?beforeDate=2023-04-27&sort=desc&offset=0&limit=100'
    'sleepList': 'https://api.fitbit.com/1.2/user/943HNF/sleep/list.json?beforeDate=2023-04-27&sort=desc&offset=0&limit=100'
}
