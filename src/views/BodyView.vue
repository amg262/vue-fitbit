<template>
  <div class="row fb-page body">
    ...
    <PolarChart
        identity="body/log/weight/date/2023-05-11.json"
    ...
    <!--    <BarChart-->
    <!--        identity="https://api.fitbit.com/1.2/user/943HNF/sleep/list.json?beforeDate=2023-05-04&sort=desc&offset=0&limit=10"-->
